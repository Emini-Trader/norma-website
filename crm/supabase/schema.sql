...
-- 2) Historia kontaktów per firma (odpowiednik kolumny "Kommentarer", ale jako log wpisów zamiast jednego pola)
...
-- 3) Automatyczne ustawianie "kto i kiedy edytował" — niezależnie od tego co wyśle frontend
...
-- 4) Row Level Security: tylko zalogowani użytkownicy (zaproszeni przez admina) mają dostęp.
